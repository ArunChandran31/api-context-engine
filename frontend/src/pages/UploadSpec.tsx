  ...
  return (
    <div className="flex items-center gap-3 py-2.5">
      ...
      <span
        className="text-[13px]"
        style={{
          color: state === 'pending' ? '#aaa' : '#1a1a1a',
...
export default function UploadSpec({ navigate }: Props) {
  ...
  const [indexedDocumentCount, setIndexedDocumentCount] = useState<number | null>(null)
  const [indexedChunkCount, setIndexedChunkCount] = useState<number | null>(null)
  const [invalidatedCacheCount, setInvalidatedCacheCount] = useState<number | null>(null)
  ...
  async function analyzeSpecification() {
    ...
    setIndexedDocumentCount(null)
    setIndexedChunkCount(null)
    setInvalidatedCacheCount(null)

    setUploadStep('validating')

    try {
      // The current backend performs validation/parsing and RAG
      // indexing inside the same upload request. These states
      // represent the stages of that synchronous operation.
      ...
      setIndexedDocumentCount(result.rag.documents_indexed)
      setIndexedChunkCount(result.rag.chunks_indexed)
      setInvalidatedCacheCount(result.rag.cache_entries_invalidated)
    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-[14px] text-[#888] mt-0.5">
            Index your OpenAPI or Swagger specification
          </p>
        </div>
      ...
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="col-span-3 flex flex-col gap-3">
          <div style={CARD}>
            <div className="p-5">
              <div className="text-[13px] font-medium text-[#555] mb-3">
                Choose an input
              </div>
            ...
            <div className="px-5 pb-5 flex gap-2">
              ...
              {uploadStep === 'ready' &&
                uploadedSpecificationId !== null && (
                  <button
                    style={BTN_SECONDARY}
                    onClick={() =>
                      navigate('explorer', {
                        specificationId:
                          uploadedSpecificationId,
                      })
                    }
                  >
                    Explore APIs →
            ...
            {uploadStep === 'ready' && (
              ...
              >
                ...
                <div className="text-[12px] text-[#16a34a] mt-0.5">
                  {uploadedEndpointCount ?? 0} endpoints discovered
                ...
                <div className="grid grid-cols-3 gap-2 mt-3">
                  ...
                  >
                    <div className="text-[16px] font-semibold text-[#15803d]">
